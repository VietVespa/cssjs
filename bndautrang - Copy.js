...
jQuery(window).load(function() {
		if(document.cookie.indexOf("adf") == -1)
		{
			...
			jQuery("#myModal").html("<a href='http://bit.ly/2sidMU3' target='_blank'><img src='http://faceseo.vn/bannerweb/hoc-seo-chuyen-sau.jpg' width='500px'/><br/>Showroom Vespa Quang Trung</a> LH PKD Việt:0934671499 <h2><a class='close-linhnguyen-modal'>X</a></h2>");
